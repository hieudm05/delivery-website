<div class="sidenav-header">
  ...
  <a class="navbar-brand px-4 py-3 m-0" href=" {{ route('hub.income.index') }} " target="_blank">
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('hub.income.index') ? 'active bg-gradient-dark text-white' : 'text-dark' }}" href="{{ route('hub.income.index') }}">
