                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ number_format($stats['pending_system']) }}đ
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $tab === 'pending_driver_commission' ? 'active' : '' }}" 
                       href="?tab=pending_driver_commission">
                        ...
                        @if($stats['pending_driver_commission'] > 0)
                        <span class="badge bg-primary ms-1">
                            {{ CodTransaction::byHub(Auth::id())->where('driver_commission_status', 'pending')->where('shipper_payment_status', 'confirmed')->count() }}
                        </span>
                        @endif
                    </a>
                </li>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                @if($tab === 'pending_driver_commission' || $tab === 'pending_system')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <small class="text-muted">{{ $trans->driver->phone ?? '' }}</small>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                ...
                                <td>
                                    @if($tab === 'pending_driver_commission')
                                    ...
                                    @elseif($tab === 'pending_system')
                                        ...
                                        <small class="text-muted">COD Fee</small>
                                    @else
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        @if($tab === 'pending_driver_commission')
                                            <button type="button" 
                                                    ...
                                                    data-bs-target="#payCommissionModal{{ $trans->id }}"
                                                    title="Trả commission">
                            ...
                            <!-- ✅ MỚI: MODAL TRẢ COMMISSION -->
                            @if($tab === 'pending_driver_commission')
                            <div class="modal fade" id="payCommissionModal{{ $trans->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('hub.cod.pay-driver-commission', $trans->id) }}" method="POST">
                                            @csrf
                                            <div class="modal-header bg-primary text-white">
                                                <h5 class="modal-title">
                                                    <i class="bi bi-cash"></i> Trả commission Driver
                                                </h5>
                                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="alert alert-info">
                                                    <p class="mb-2"><strong>Driver:</strong> {{ $trans->driver->full_name }}</p>
                                                    <p class="mb-2"><strong>Commission:</strong> 
                                                        <span class="text-primary fs-5">{{ number_format($trans->driver_commission) }}đ</span>
                                                    </p>
                                                    <p class="mb-0"><small>= {{ number_format($trans->shipping_fee) }}đ × {{ config('delivery.driver_commission_rate') * 100 }}%</small></p>
                                                </div>
...
<!-- ✅ MỚI: MODAL TRẢ COMMISSION HÀNG LOẠT -->
<div class="modal fade" id="batchPayCommissionModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('hub.cod.batch-pay-driver-commission') }}" method="POST">
                @csrf
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-cash-stack"></i> Trả commission hàng loạt
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSelected() {
        ...
        const container = document.getElementById('selectedCommissions') || document.getElementById('selectedTransactions');
