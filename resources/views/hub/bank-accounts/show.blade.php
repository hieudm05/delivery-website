        ...
        <div class="col-lg-12">
            <div class="card shadow-lg">
                <div class="card-header text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('hub.bank-accounts.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 d-flex gap-2">
                        @if(!$bankAccount->isVerified())
                        <a href="{{ route('hub.bank-accounts.edit', $bankAccount->id) }}" class="btn btn-primary">
                            <i class="fas fa-edit"></i> Chỉnh sửa
                        </a>
                        @endif
                        <a href="{{ route('hub.bank-accounts.index') }}" class="btn btn-secondary">
