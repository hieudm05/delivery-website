        ...
        <div class="col-12">
            <div class="card shadow-lg">
                <div class="card-header text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('hub.bank-accounts.create') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    @if ($bankAccounts->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('hub.bank-accounts.create') }}" class="btn btn-primary">
                                    ...
                                    @foreach ($bankAccounts as $account)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    @if ($account->isVerified())
                                                        <form action="{{ route('hub.bank-accounts.make-primary', $account->id) }}" 
                                                              method="POST" 
                                                              class="d-inline"
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group" role="group">
                                                    {{-- Xem chi tiết --}}
                                                    <a href="{{ route('hub.bank-accounts.show', $account->id) }}" 
                                                    ...
                                                    @if (!$account->isVerified())
                                                        <a href="{{ route('hub.bank-accounts.edit', $account->id) }}" 
...
<script>
    function deleteAccount(accountId) {
        if (confirm('Bạn có chắc chắn muốn xóa tài khoản này?\nHành động này không thể hoàn tác!')) {
            ...
            form.action = `/hub/bank-accounts/${accountId}`;
            form.submit();
        }
    }
