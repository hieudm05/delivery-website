  ...
  <div class="row gy-4 d-flex justify-content-between">
    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
      ...
      <form action="#" class="form-search d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="200">
        <input type="text" class="form-control" placeholder="Nhập địa chỉ nhận hàng tại Hà Nội">
      ...
      <div class="row gy-4" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="col-lg-3 col-6">
          <div class="stats-item text-center w-100 h-100">
            <span data-purecounter-start="0" data-purecounter-end="98" data-purecounter-duration="0" class="purecounter">98</span>
            <p>% Hài Lòng</p>
          </div>
        </div>
