        ...
        <div class="col-12 col-md-10">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ isset($bankAccount) ? route('driver.bank-accounts.update', $bankAccount->id) : route('driver.bank-accounts.store') }}" 
                        ...
                        <div class="d-flex gap-2 mt-3">
                            ...
                            <a href="{{ route('driver.bank-accounts.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
