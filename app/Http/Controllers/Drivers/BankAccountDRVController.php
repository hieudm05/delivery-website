...
class BankAccountDRVController extends Controller
{
    ...
    /**
     * Danh sách tài khoản ngân hàng của tài xế
     */
    public function indexDriver()
    {
        ...
        return view('driver.bank-accounts.index', [
    ...
    public function createDriver()
    {
        ...
        return view('driver.bank-accounts.create', [
            'banks' => $banks,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('driver.bank-accounts.index')
    ...
    public function show($id)
    {
        ...
        return view('driver.bank-accounts.show', [
    ...
    public function edit($id)
    {
        ...
        if ($bankAccount->isVerified()) {
            return redirect()->route('driver.bank-accounts.show', $id)
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('driver.bank-accounts.show', $bankAccount->id)
