...
class BankAccountController extends Controller
{
    ...
    /**
     * Danh sách tài khoản ngân hàng của customer
     */
    public function indexCustomer()
    {
        ...
        return view('customer.dashboard.bank-accounts.index', [
    ...
    public function createCustomer()
    {
        ...
        return view('customer.dashboard.bank-accounts.create', [
            'banks' => $banks,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('customer.bank-accounts.index')
    ...
    public function show($id)
    {
        ...
        return view('customer.dashboard.bank-accounts.show', [
    ...
    public function edit($id)
    {
        ...
        if ($bankAccount->isVerified()) {
            return redirect()->route('customer.bank-accounts.show', $id)
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('customer.bank-accounts.show', $bankAccount->id)
